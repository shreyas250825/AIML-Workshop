...
// UPDATED: Uses "PasswordSheets" as the sheet name

function doGet(e) {
  const sheet = SpreadsheetApp.getActiveSpreadsheet().getSheetByName('PasswordSheets');
  
  if (!sheet) {
    return ContentService.createTextOutput(JSON.stringify({
      success: false,
      error: 'PasswordSheets sheet not found'
